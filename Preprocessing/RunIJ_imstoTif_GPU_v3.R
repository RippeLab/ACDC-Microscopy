...
# Output: converted Tif images, bash script, ImageJ log file (IJ_imstoTif.oclusterjobnumber) and ImageJ error file (IJ_imstoTif.eclusterjobnumber)

## Step 1 ##
# Copy the macro to your database folder and change the path of the macro
...
# Define where the macro is located on the database
